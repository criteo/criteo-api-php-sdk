...
```php
createAdSetV24Q1($create_ad_set_v24_q1_request): \criteo\api\marketingsolutions\v2024_07\Model\ResponseReadAdSetV24Q1
```
...
```php
getAdSetV24Q1($ad_set_id): \criteo\api\marketingsolutions\v2024_07\Model\ResponseReadAdSetV24Q1
```
...
```php
getCampaignV23Q1($campaign_id): \criteo\api\marketingsolutions\v2024_07\Model\CampaignV23Q1Response
```
...
```php
getCategoryBidList($ad_set_id): \criteo\api\marketingsolutions\v2024_07\Model\AdSetCategoryBidListResponse
```
...
```php
patchAdSetsV24Q1($requests_patch_ad_set_v24_q1): \criteo\api\marketingsolutions\v2024_07\Model\ResponsesAdSetIdV24Q1
```
...
```php
patchCategoryBidList($ad_set_id, $patch_ad_set_category_bid_list_request): \criteo\api\marketingsolutions\v2024_07\Model\PatchAdSetCategoryBidResultListResponse
```
...
```php
searchAdSetsV24Q1($ad_set_search_request_v24_q1): \criteo\api\marketingsolutions\v2024_07\Model\ResponsesReadAdSetV24Q1
```
...
```php
searchCampaignsV23Q1($campaign_search_request_v23_q1): \criteo\api\marketingsolutions\v2024_07\Model\CampaignV23Q1ListResponse
```
