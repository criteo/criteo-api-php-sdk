...
/**
     ...
     * @throws \criteo\api\marketingsolutions\v2025_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2025_01\Model\DeleteAudienceContactListResponse|\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2025_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2025_01\Model\DeleteAudienceContactListResponse|\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function call01AudiencesAudienceSegmentIdContactlistDeleteWithHttpInfo($audience_segment_id, string $contentType = self::contentTypes['call01AudiencesAudienceSegmentIdContactlistDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 403:
                    if ('\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\marketingsolutions\v2025_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2025_01\Model\ModifyAudienceResponse|\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse|\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2025_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2025_01\Model\ModifyAudienceResponse|\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse|\criteo\api\marketingsolutions\v2025_01\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
