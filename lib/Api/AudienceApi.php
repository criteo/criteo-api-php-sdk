...
/**
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentBulkCreateInputV1 $audience_segment_bulk_create_input_v1 Segment creation parameter (required)
     ...
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkCreateAudienceSegmentsWithHttpInfo($audience_segment_bulk_create_input_v1, string $contentType = self::contentTypes['bulkCreateAudienceSegments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1ListResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1ListResponse',
    ...
    public function bulkCreateAudienceSegmentsRequest($audience_segment_bulk_create_input_v1, string $contentType = self::contentTypes['bulkCreateAudienceSegments'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceBulkCreateInputV1 $audience_bulk_create_input_v1  (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkCreateAudiencesWithHttpInfo($audience_bulk_create_input_v1, string $contentType = self::contentTypes['bulkCreateAudiences'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function bulkCreateAudiencesRequest($audience_bulk_create_input_v1, string $contentType = self::contentTypes['bulkCreateAudiences'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audiences/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentBulkDeleteInputV1 $audience_segment_bulk_delete_input_v1 Segment delete request. (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentIdEntityV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentIdEntityV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkDeleteAudienceSegmentsWithHttpInfo($audience_segment_bulk_delete_input_v1, string $contentType = self::contentTypes['bulkDeleteAudienceSegments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentIdEntityV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentIdEntityV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentIdEntityV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentIdEntityV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentIdEntityV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function bulkDeleteAudienceSegmentsRequest($audience_segment_bulk_delete_input_v1, string $contentType = self::contentTypes['bulkDeleteAudienceSegments'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceBulkDeleteInputV1 $audience_bulk_delete_input_v1  (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceIdEntityV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceIdEntityV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkDeleteAudiencesWithHttpInfo($audience_bulk_delete_input_v1, string $contentType = self::contentTypes['bulkDeleteAudiences'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceIdEntityV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceIdEntityV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceIdEntityV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceIdEntityV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceIdEntityV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function bulkDeleteAudiencesRequest($audience_bulk_delete_input_v1, string $contentType = self::contentTypes['bulkDeleteAudiences'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audiences/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentBulkUpdateInputV1 $audience_segment_bulk_update_input_v1 Segment Update request (required)
    ...
    public function bulkUpdateAudienceSegmentsRequest($audience_segment_bulk_update_input_v1, string $contentType = self::contentTypes['bulkUpdateAudienceSegments'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceBulkUpdateInputV1 $audience_bulk_update_input_v1  (required)
    ...
    public function bulkUpdateAudiencesRequest($audience_bulk_update_input_v1, string $contentType = self::contentTypes['bulkUpdateAudiences'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audiences';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEntityV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEntityV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function computeAudienceSegmentsSizesWithHttpInfo($audience_segment_compute_sizes_input_v1, string $contentType = self::contentTypes['computeAudienceSegmentsSizes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEntityV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEntityV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEntityV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEntityV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEntityV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function computeAudienceSegmentsSizesRequest($audience_segment_compute_sizes_input_v1, string $contentType = self::contentTypes['computeAudienceSegmentsSizes'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments/compute-sizes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceComputeSizesInputV1 $audience_compute_sizes_input_v1  (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEntityV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEntityV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function computeAudiencesSizesWithHttpInfo($audience_compute_sizes_input_v1, string $contentType = self::contentTypes['computeAudiencesSizes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEntityV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEntityV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEntityV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEntityV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEntityV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function computeAudiencesSizesRequest($audience_compute_sizes_input_v1, string $contentType = self::contentTypes['computeAudiencesSizes'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audiences/compute-sizes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEstimateSizeInputV1 $audience_segment_estimate_size_input_v1  (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEstimationV1Response
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEstimationV1Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function estimateAudienceSegmentSizeWithHttpInfo($audience_segment_estimate_size_input_v1, string $contentType = self::contentTypes['estimateAudienceSegmentSize'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEstimationV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEstimationV1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEstimationV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEstimationV1Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSizeEstimationV1Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function estimateAudienceSegmentSizeRequest($audience_segment_estimate_size_input_v1, string $contentType = self::contentTypes['estimateAudienceSegmentSize'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments/estimate-size';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceEstimateSizeInputV1 $audience_estimate_size_input_v1  (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEstimationV1Response
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEstimationV1Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function estimateAudienceSizeWithHttpInfo($audience_estimate_size_input_v1, string $contentType = self::contentTypes['estimateAudienceSize'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEstimationV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEstimationV1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEstimationV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEstimationV1Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSizeEstimationV1Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function estimateAudienceSizeRequest($audience_estimate_size_input_v1, string $contentType = self::contentTypes['estimateAudienceSize'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audiences/estimate-size';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\ContactListStatisticsEntityV1Response
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\ContactListStatisticsEntityV1Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAudienceSegmentContactListStatisticsWithHttpInfo($audience_segment_id, string $contentType = self::contentTypes['getAudienceSegmentContactListStatistics'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\ContactListStatisticsEntityV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\ContactListStatisticsEntityV1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\ContactListStatisticsEntityV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\ContactListStatisticsEntityV1Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\ContactListStatisticsEntityV1Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAudienceSegmentContactListStatisticsRequest($audience_segment_id, string $contentType = self::contentTypes['getAudienceSegmentContactListStatistics'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments/{audience-segment-id}/contact-list/statistics';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentBrandEntityV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentBrandEntityV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAudienceSegmentsInMarketBrandsWithHttpInfo($advertiser_id, $country, string $contentType = self::contentTypes['getAudienceSegmentsInMarketBrands'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentBrandEntityV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentBrandEntityV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentBrandEntityV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentBrandEntityV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentBrandEntityV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAudienceSegmentsInMarketBrandsRequest($advertiser_id, $country, string $contentType = self::contentTypes['getAudienceSegmentsInMarketBrands'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments/in-market-brands';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentInterestEntityV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentInterestEntityV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAudienceSegmentsInMarketInterestsWithHttpInfo($advertiser_id, $country, string $contentType = self::contentTypes['getAudienceSegmentsInMarketInterests'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentInterestEntityV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentInterestEntityV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentInterestEntityV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentInterestEntityV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\InMarketAudienceSegmentInterestEntityV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAudienceSegmentsInMarketInterestsRequest($advertiser_id, $country, string $contentType = self::contentTypes['getAudienceSegmentsInMarketInterests'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments/in-market-interests';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentSearchInputV1 $audience_segment_search_input_v1 Segment search filters. (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchAudienceSegmentsWithHttpInfo($audience_segment_search_input_v1, $limit = 50, $offset = 0, string $contentType = self::contentTypes['searchAudienceSegments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchAudienceSegmentsRequest($audience_segment_search_input_v1, $limit = 50, $offset = 0, string $contentType = self::contentTypes['searchAudienceSegments'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audience-segments/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AudienceSearchInputV1 $audience_search_input_v1 Audience search filters. (required)
     * @param  int $limit The number of elements to be returned. The default is 50 and the maximum is 100. (optional, default to 50)
     * @param  int $offset The (zero-based) offset into the collection. The default is 0. (optional, default to 0)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1AudienceSearchMetadataV1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1AudienceSearchMetadataV1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchAudiencesWithHttpInfo($audience_search_input_v1, $limit = 50, $offset = 0, string $contentType = self::contentTypes['searchAudiences'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1AudienceSearchMetadataV1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1AudienceSearchMetadataV1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1AudienceSearchMetadataV1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1AudienceSearchMetadataV1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\AudienceEntityV1AudienceSearchMetadataV1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchAudiencesRequest($audience_search_input_v1, $limit = 50, $offset = 0, string $contentType = self::contentTypes['searchAudiences'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/audiences/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
