...
/**
     ...
     * @return \SplFileObject|\criteo\api\marketingsolutions\v2024_01\Model\Outcome|\criteo\api\marketingsolutions\v2024_01\Model\Outcome
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\criteo\api\marketingsolutions\v2024_01\Model\Outcome|\criteo\api\marketingsolutions\v2024_01\Model\Outcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdsetReportWithHttpInfo($statistics_report_query_message = null, string $contentType = self::contentTypes['getAdsetReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\criteo\api\marketingsolutions\v2024_01\Model\Outcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_01\Model\Outcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_01\Model\Outcome', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_01\Model\Outcome',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_01\Model\PlacementsReportQueryMessageListRequest $placements_report_query_message_list_request placements_report_query_message_list_request (optional)
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_01\Model\PlacementsReportQueryMessageListRequest $placements_report_query_message_list_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPlacementsReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_01\Model\TransactionsReportQueryMessageListRequest $transactions_report_query_message_list_request transactions_report_query_message_list_request (optional)
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_01\Model\TransactionsReportQueryMessageListRequest $transactions_report_query_message_list_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTransactionsReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \criteo\api\marketingsolutions\v2024_01\Model\TransparencyQueryMessage $transparency_query_message The query message. (optional)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_01\Model\TransparencyReportListResponse|\criteo\api\marketingsolutions\v2024_01\Model\Outcome|\criteo\api\marketingsolutions\v2024_01\Model\Outcome
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_01\Model\TransparencyReportListResponse|\criteo\api\marketingsolutions\v2024_01\Model\Outcome|\criteo\api\marketingsolutions\v2024_01\Model\Outcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransparencyReportWithHttpInfo($advertiser_id, $transparency_query_message = null, string $contentType = self::contentTypes['getTransparencyReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_01\Model\TransparencyReportListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_01\Model\TransparencyReportListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_01\Model\TransparencyReportListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\marketingsolutions\v2024_01\Model\TransparencyReportListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_01\Model\TransparencyReportListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
