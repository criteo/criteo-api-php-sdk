...
/**
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\StatisticsReportQueryMessage $statistics_report_query_message statistics_report_query_message (optional)
     ...
     * @return \SplFileObject|\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails|\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails
     */
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\StatisticsReportQueryMessage $statistics_report_query_message (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAdsetReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails|\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdsetReportWithHttpInfo($statistics_report_query_message = null, string $contentType = self::contentTypes['getAdsetReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAdsetReportRequest($statistics_report_query_message = null, string $contentType = self::contentTypes['getAdsetReport'][0])
    {
        ...
        $resourcePath = '/2024-04/statistics/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\PlacementsReportQueryDataMessage $placements_report_query_data_message placements_report_query_data_message (optional)
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\PlacementsReportQueryDataMessage $placements_report_query_data_message (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPlacementsReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getPlacementsReportRequest($placements_report_query_data_message = null, string $contentType = self::contentTypes['getPlacementsReport'][0])
    {
        ...
        $resourcePath = '/2024-04/placements/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\TransactionsReportQueryDataMessage $transactions_report_query_data_message transactions_report_query_data_message (optional)
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\TransactionsReportQueryDataMessage $transactions_report_query_data_message (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTransactionsReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getTransactionsReportRequest($transactions_report_query_data_message = null, string $contentType = self::contentTypes['getTransactionsReport'][0])
    {
        ...
        $resourcePath = '/2024-04/transactions/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\TransparencyQueryMessage $transparency_query_message transparency_query_message (optional)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\TransparencyReportDataMessage|\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails|\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails
     */
     ...
     *
     * @param  int $advertiser_id The advertiser id to fetch the transparency data. (required)
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\TransparencyQueryMessage $transparency_query_message (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTransparencyReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\TransparencyReportDataMessage|\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails|\criteo\api\marketingsolutions\v2024_04\Model\ProblemsDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransparencyReportWithHttpInfo($advertiser_id, $transparency_query_message = null, string $contentType = self::contentTypes['getTransparencyReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\TransparencyReportDataMessage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\TransparencyReportDataMessage' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\TransparencyReportDataMessage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\TransparencyReportDataMessage';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\TransparencyReportDataMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getTransparencyReportRequest($advertiser_id, $transparency_query_message = null, string $contentType = self::contentTypes['getTransparencyReport'][0])
    {
        ...
        $resourcePath = '/2024-04/log-level/advertisers/{advertiser-id}/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
