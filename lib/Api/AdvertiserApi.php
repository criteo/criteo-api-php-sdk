...
/**
     ...
     * @return \criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse|\criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse|\criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiPortfolioGetWithHttpInfo(string $contentType = self::contentTypes['apiPortfolioGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse', []),
            ...
            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\GetPortfolioResponse',
    ...
    public function apiPortfolioGetRequest(string $contentType = self::contentTypes['apiPortfolioGet'][0])
    {
        ...
        $resourcePath = '/2024-04/advertisers/me';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
