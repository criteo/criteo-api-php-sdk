...
/**
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\CreateAdSetRequest $create_ad_set_request the ad sets to create (required)
     ...
     * @return \criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSet
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdSetWithHttpInfo($create_ad_set_request, string $contentType = self::contentTypes['createAdSet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSet' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSet' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSet', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSet';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSet',
    ...
    public function createAdSetRequest($create_ad_set_request, string $contentType = self::contentTypes['createAdSet'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/ad-sets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSetV23Q1
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSetV23Q1, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdSetV23Q1WithHttpInfo($ad_set_id, string $contentType = self::contentTypes['getAdSetV23Q1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSetV23Q1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSetV23Q1' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSetV23Q1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSetV23Q1';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\ResponseReadAdSetV23Q1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAdSetV23Q1Request($ad_set_id, string $contentType = self::contentTypes['getAdSetV23Q1'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/ad-sets/{ad-set-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\RequestsPatchAdSet $requests_patch_ad_set List of adsets to patch. (optional)
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AdSetSearchRequestV23Q1 $ad_set_search_request_v23_q1 ad_set_search_request_v23_q1 (optional)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_04\Model\ResponsesReadAdSetV23Q1
     */
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2024_04\Model\AdSetSearchRequestV23Q1 $ad_set_search_request_v23_q1 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchAdSetsV23Q1'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_04\Model\ResponsesReadAdSetV23Q1, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchAdSetsV23Q1WithHttpInfo($ad_set_search_request_v23_q1 = null, string $contentType = self::contentTypes['searchAdSetsV23Q1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_04\Model\ResponsesReadAdSetV23Q1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_04\Model\ResponsesReadAdSetV23Q1' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_04\Model\ResponsesReadAdSetV23Q1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_04\Model\ResponsesReadAdSetV23Q1';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_04\Model\ResponsesReadAdSetV23Q1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchAdSetsV23Q1Request($ad_set_search_request_v23_q1 = null, string $contentType = self::contentTypes['searchAdSetsV23Q1'][0])
    {
        ...
        $resourcePath = '/2024-04/marketing-solutions/ad-sets/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
