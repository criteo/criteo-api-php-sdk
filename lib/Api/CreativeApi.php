...
/**
     ...
     * @param  \criteo\api\marketingsolutions\v2024_10\Model\AdWriteRequest $ad_write_request ad_write_request (required)
     ...
     * @return \criteo\api\marketingsolutions\v2024_10\Model\AdResponse
     */
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2024_10\Model\AdWriteRequest $ad_write_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAdvertiserAd'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_10\Model\AdResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdvertiserAdWithHttpInfo($advertiser_id, $ad_write_request, string $contentType = self::contentTypes['createAdvertiserAd'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2024_10\Model\AdResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_10\Model\AdResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_10\Model\AdResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_10\Model\AdResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_10\Model\AdResponse',
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2024_10\Model\CreateCouponRequest $create_coupon_request create_coupon_request (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_10\Model\CouponResponse
     */
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2024_10\Model\CreateCouponRequest $create_coupon_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAdvertiserCoupon'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_10\Model\CouponResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdvertiserCouponWithHttpInfo($advertiser_id, $create_coupon_request, string $contentType = self::contentTypes['createAdvertiserCoupon'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2024_10\Model\CouponResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_10\Model\CouponResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_10\Model\CouponResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_10\Model\CouponResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_10\Model\CouponResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2024_10\Model\CreativeWriteRequest $creative_write_request creative_write_request (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_10\Model\CreativeResponse
     */
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2024_10\Model\CreativeWriteRequest $creative_write_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAdvertiserCreative'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_10\Model\CreativeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdvertiserCreativeWithHttpInfo($advertiser_id, $creative_write_request, string $contentType = self::contentTypes['createAdvertiserCreative'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2024_10\Model\CreativeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_10\Model\CreativeResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_10\Model\CreativeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_10\Model\CreativeResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_10\Model\CreativeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \criteo\api\marketingsolutions\v2024_10\Model\UpdateCouponRequest $update_coupon_request update_coupon_request (required)
     ...
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  string $id The Coupon identifier to edit. (required)
     * @param  \criteo\api\marketingsolutions\v2024_10\Model\UpdateCouponRequest $update_coupon_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['editAdvertiserCoupon'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_10\Model\AdListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_10\Model\AdListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserAdsWithHttpInfo($advertiser_id, $limit = null, $offset = null, string $contentType = self::contentTypes['getAdvertiserAds'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_10\Model\AdListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_10\Model\AdListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_10\Model\AdListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_10\Model\AdListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_10\Model\AdListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_10\Model\CouponSupportedSizesResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_10\Model\CouponSupportedSizesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserCouponSupportedSizesWithHttpInfo($advertiser_id, $ad_set_id = null, string $contentType = self::contentTypes['getAdvertiserCouponSupportedSizes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_10\Model\CouponSupportedSizesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_10\Model\CouponSupportedSizesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_10\Model\CouponSupportedSizesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_10\Model\CouponSupportedSizesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_10\Model\CouponSupportedSizesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_10\Model\CouponListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_10\Model\CouponListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserCouponsWithHttpInfo($advertiser_id, $limit = null, $offset = null, string $contentType = self::contentTypes['getAdvertiserCoupons'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_10\Model\CouponListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_10\Model\CouponListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_10\Model\CouponListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_10\Model\CouponListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_10\Model\CouponListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_10\Model\CreativeListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_10\Model\CreativeListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserCreativesWithHttpInfo($advertiser_id, $limit = null, $offset = null, string $contentType = self::contentTypes['getAdvertiserCreatives'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_10\Model\CreativeListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_10\Model\CreativeListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_10\Model\CreativeListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_10\Model\CreativeListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_10\Model\CreativeListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
